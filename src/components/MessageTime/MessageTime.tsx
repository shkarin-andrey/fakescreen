...
const MessageTime: FC<IMessageTime> = ({
  ...
  return (
    <div
      className={`flex items-end float-right text-right text-[10px] pb-[4px] pt-[1px] pl-[5px] pr-[3px] leading-none rounded-3xl ${classNameBg} ${classNameTextColor} ${className}`}
    >
