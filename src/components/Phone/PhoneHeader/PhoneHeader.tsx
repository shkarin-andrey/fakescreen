...
const PhoneHeader: FC = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-[11] overflow-hidden h-[72px] bg-[#FFFFFF]/75 dark:bg-[#2E2E30]/75 backdrop-blur-[100px] border-b border-0 border-solid border-[#DAD8D8]/75 dark:border-[#2E2E30]/75'>
