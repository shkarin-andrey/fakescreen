...
const PhoneHeader: FC = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-[11] overflow-hidden h-[72px] bg-[#FFFFFF]/75 backdrop-blur-[100px] border-b border-0 border-solid border-[#DAD8D8]/75'>
      <div className='h-[34px] pl-[17px] pr-3 pt-[3px] flex justify-between items-center text-xs font-semibold text-[#171717] relative'>
        <div
