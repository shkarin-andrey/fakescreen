...
const PhoneFooter: FC = () => {
  return (
    <div className='w-full pl-[4px] pb-[7px] pr-[8px] bg-[#FFFFFF]/75 dark:bg-black/75 backdrop-blur-[69px] border-t border-0 border-solid border-[#E8E8E8]/75 dark:border-[#2E2E30]/75'>
