...
const PhoneUserInfo: FC = () => {
  ...
  return (
    <div className='w-full bg-[#F6F6F6] h-[38px] px-[6px] grid grid-cols-9 items-center text-xs font-semibold text-[#171717]'>
      ...
      <div className='text-sm col-span-5 flex flex-col items-center leading-none'>
        ...
        <span className={`text-xs ${isStatusOnline}`}>{status}</span>
      </div>
      <div className='col-span-2 ml-auto w-8 h-8 rounded-full overflow-hidden'>
        <Avatar
          size='large'
          src={avatarFile}
